...
async function createEarlyEvaluationForm() {
    console.log('🚀 Checking and creating Early Design & Concept Evaluation Form for CP321007...');
...
การตอบแบบสอบถามนี้ใช้เวลาประมาณ 3–5 นาที และข้อมูลทั้งหมดจะถูกนำไปใช้เพื่อประโยชน์ทางการศึกษาและการพัฒนาระบบเท่านั้น`;
        ...
        const formSchema = [
            ...
            {
                id: 'sec1_q1_role',
                section: 'ส่วนที่ 1: ข้อมูลทั่วไปของผู้ตอบแบบสอบถาม (Demographics & Baseline)',
            ...
            {
                id: 'sec2_q1_layout',
                section: 'ส่วนที่ 2: การประเมินความรู้สึกแรกเห็นและการคาดการณ์ความสะดวก (Early UI & Perceived Usability)',
            ...
            // ส่วนที่ 3
            {
                ...
                section: 'ส่วนที่ 3: ความรู้สึกและคุณค่าที่คาดว่าจะได้รับหากนำไปใช้จริง (Perceived Value & Intention to Use)',
            ...
            // ส่วนที่ 4
            {
                ...
                section: 'ส่วนที่ 4: ความคิดเห็นและข้อเสนอแนะเพิ่มเติม (Qualitative Feedback)',
        ...
        if (existingForm.rows.length > 0) {
            ...
            console.log(`ℹ️ Form already exists with ID ${formId}. Updating schema and content...`);
            await pool.query(
                `UPDATE forms 
            ...
            console.log(`✅ Form ID ${formId} updated successfully.`);
        } else {
            ...
            console.log(`🎉 Created new form successfully with separate Form ID: ${formId}`);
        }

        await pool.end();
        return formId;
    } catch (err) {
        console.error('❌ Failed to create/update CP321007 form:', err);
        process.exit(1);
    }
}
...
if (require.main === module) {
    createEarlyEvaluationForm().then((id) => {
        console.log(`✅ Completed. Distinct Form ID is: ${id}`);
        process.exit(0);
    });
}
